...
public class DatosPrueba {
    public static void cargar(){
        ...
        Categoria c1 = logica.agregarCategoria(new Categoria("Automovil"));
        ...
        logica.agregarPuesto(new Puesto("Puesto San Jose","Ruta4 km98",tarifas4));
        ...
        logica.agregarPuesto(new Puesto("Puesto Tacuarembo","Ruta7 km347",tarifas3));
